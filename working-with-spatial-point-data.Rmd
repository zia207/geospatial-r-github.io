...
```{r}
# Define data folder
dataFolder<-"D://Dropbox//Spatial Data Analysis and Processing in R//DATA_05//DATA_05//"
```
...
knitr::include_graphics('E:\\GitHub\\geospatial-r-github\\Image\\PNG_FILE_06\\Pic1.png')
```
