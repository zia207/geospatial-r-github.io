...
```{r}
# Define data folder
dataFolder<-"D://Dropbox/Spatial Data Analysis and Processing in R//DATA_04//DATA_04//"
```
...
knitr::include_graphics("E:\\GitHub\\geospatial-r-github\\Image\\PNG_FILE_04\\Clip.png")
```
...
knitr::include_graphics('E:\\GitHub\\geospatial-r-github\\Image\\PNG_FILE_04\\Union.png')
```
...
knitr::include_graphics('E:\\GitHub\\geospatial-r-github\\Image\\PNG_FILE_04\\Dissolve.png')
```
...
knitr::include_graphics('E:\\GitHub\\geospatial-r-github\\Image\\PNG_FILE_04\\Intersect.png')
```
