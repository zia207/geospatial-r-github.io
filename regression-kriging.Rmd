...
knitr::include_graphics('E:\\GitHub\\geospatial-r-github\\Image\\PNG_FILE_07\\RK.png')
```
...
```{r echo=FALSE, out.width='60%', fig.align="center"}
knitr::include_graphics('E:\\GitHub\\geospatial-r-github\\Image\\PNG_FILE_07\\metaModel.png')
```
