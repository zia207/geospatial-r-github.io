...
In this excercise we will explore the crime rate at City at Buffalo for the year 2018. The crime data was downloaded from [here](https://data.buffalony.gov/). The shape file of Buffalo city area and crime data for the year 2018 could be found [here](https://www.dropbox.com/s/32haeg8mjoinwdi/Data_Crime.7z?dl=0).
...
```{r message=F, warning=F}
# Define data folder
dataFolder<-"D:\\Dropbox\\Spatial Data Analysis and Processing in R\\Data_Crime\\"
